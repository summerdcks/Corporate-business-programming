...
<head> <!--머릿말 시작-->
	...
	<title>gongji_insert</title> <!--타이틀에 새겨질 글자-->
	<style> /*CSS 스타일시트*/
...
<h1>공지사항 입력</h1> <!--표제-->
	...
	<!-- 테이블 시작, 클래스 type10지정, 너비 650픽셀, 테두리 1픽셀, 셀간격 없음, 셀여백 5픽셀 -->
		<tr> <!-- 행 시작 -->
			...
			<td>NEW<input type=hidden name=id value=''></td> <!-- 셀 안에 문자열 출력 -->
		</tr> <!-- 행 끝 -->
		<tr> <!-- 행 시작 -->
		...
		<tr> <!-- 행 시작 -->
			...
			<td><textarea style='width:500px; height:250px;' name=content cols=70 row=600 maxlength=10000></textarea></td>
			<!-- 셀 안에 텍스트 입력란 생성, 너비 500픽셀, 세로 250픽셀, content로 지정, 70줄, 줄마다 600자, 최대 10000자 가능 -->
		</tr> <!-- 행 끝 -->
	</table> <!--테이블 끝-->
